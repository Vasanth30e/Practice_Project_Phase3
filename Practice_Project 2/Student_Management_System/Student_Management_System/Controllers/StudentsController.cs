...
namespace Student_Management_System.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,FirstName,LastName,DateOfBirth,ClassID,SubjectID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,FirstName,LastName,DateOfBirth,ClassID,SubjectID")] Student student)
        {
            if (ModelState.IsValid)
            {
